...
/**
 * Простейший HTTP-сервер для отображения приветственной страницы CRM.
 * Использует встроенный JDK HttpServer и слушает указанный порт.
 */
public class HelloCrmServer {
    ...
    /**
     * Запускает сервер и регистрирует обработчик для эндпоинта /hello.
     * После запуска сервер обрабатывает входящие HTTP-запросы.
     */
    public void start() {
    ...
    /**
     * Обработчик HTTP-запросов к эндпоинту /hello.
     * Возвращает HTML-страницу "Hello CRM!" только на GET-запросы.
     */
