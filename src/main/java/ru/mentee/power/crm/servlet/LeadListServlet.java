...
/**
 * Сервлет для отображения списка лидов (потенциальных клиентов) в виде HTML таблицы. Обрабатывает
 * GET-запросы по адресу /leads. Получает данные через LeadService.
 */
@WebServlet("/leads")
