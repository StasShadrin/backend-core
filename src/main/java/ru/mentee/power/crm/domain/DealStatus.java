...
/**
 * Статусы сделки в воронке продаж. Реализует паттерн State Machine: определяет допустимые переходы
 * между состояниями.
 */
public enum DealStatus {
  ...
  /**
   * Проверяет, можно ли перейти из текущего статуса в целевой. Терминальные состояния (WON, LOST)
   * не допускают никаких переходов.
   */
