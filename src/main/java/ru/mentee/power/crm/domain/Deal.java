...
public class Deal {
     ...
     *
     * @param leadId уникальный идентификатор исходного лида
     * @param amount сумма сделки (обязательна)
     */
    ...
    /**
     * Безопасно изменяет статус сделки, проверяя валидность перехода.
     * Выбрасывает исключение, если переход запрещён State Machine.
     *
