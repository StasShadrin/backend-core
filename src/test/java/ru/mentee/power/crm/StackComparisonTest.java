 ...
 * Полностью автономный: запускает оба сервера, сравнивает ответы, останавливает серверы.
 * Использует динамические порты для надёжной работы в CI/CD.
 */
class StackComparisonTest {
    ...
    /**
     * Считает строки <tr в <tbody>.
     * Предполагает, что HTML содержит одну <tr в <thead>,
     * поэтому вычитаем 2: одну для пустой части до первого <tr, и одну для шапки.
     */
