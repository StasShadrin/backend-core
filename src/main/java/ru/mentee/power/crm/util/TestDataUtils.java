...
/** Утилита для генерации тестовых лидов. Создаёт 50 уникальных записей с разными статусами. */
public class TestDataUtils {

  private static final List<String> NAMES =
      List.of("Alice", "Bob", "Charlie", "Diana", "Eve", "Frank", "Grace", "Henry", "Ivy", "Jack");
  ...
  private static final List<LeadStatus> STATUSES =
