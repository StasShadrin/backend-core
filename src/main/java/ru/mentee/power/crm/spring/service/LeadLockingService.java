...
/**
 * Сервис для демонстрации pessimistic и optimistic locking. Используется в тестах конкурентного
 * доступа (BCORE-30).
 */
@Service
...
public class LeadLockingService {
  ...
  /**
   * Критическая операция с pessimistic locking. Используется для
  ...
  /**
   * Блокирует два лида в указанном порядке. Используется для демонстрации deadlock при разном
   * порядке блокировок.
   */
  @Transactional
